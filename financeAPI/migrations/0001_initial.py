    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj_money', models.FloatField(db_index=True, default=0, max_length=1000000000000, verbose_name='Сумма для цели')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('all_money', models.FloatField(blank=True, default=0, max_length=1000000000000, verbose_name='Баланс')),
